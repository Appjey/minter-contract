...
const MINT_AMOUNT = 10000000; // The amount of tokens to mint

const jettonParams = {
  owner: Address.parse("UQA3t8bLMVefvnSxuEQ0lavt9OeIu9d--lNJ5w8LoNfe7ye_"),
  name: "RangoTon",
  symbol: "RAPA",
  image: "https://avatars.githubusercontent.com/u/43535680?v=4", // Image url
